...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [RAISE] = {
        ...
        {KC_LSFT, KC_F7,KC_F8,KC_F9, KC_F10,KC_F11,KC_F12,KC_NUHS,KC_NUBS,KC_PGDN,KC_PGUP, KC_RSFT},
        {KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX,    KC_TRNS,     KC_TRNS, KC_TRNS, XXXXXXX, KC_TRNS}
    },
    [ENTFN] = {
        {KC_TRNS,  M(M_PTAB), M(M_NTAB), M(M_PSPC), M(M_NSPC), KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,M(M_ZOUT),M(M_ZOIN),  KC_DEL},
    ...
    [MOUSE] = {
        {KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_BTN2,   KC_BTN1,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS},
    ...
    [RAISX] = {
        ...
        {KC_LSFT, KC_F19,KC_F20,KC_F21, KC_F22,KC_F23,KC_F24,KC_NUHS,KC_NUBS,KC_HOME,KC_END, KC_RSFT},
        {KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX,    KC_TRNS,     KC_TRNS, KC_TRNS, XXXXXXX, KC_TRNS}
    },
    [ADJUST] = {
